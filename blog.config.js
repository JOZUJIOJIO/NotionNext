...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '曜变 YAO-ION', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个不会代码的科技爱好者', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://bento.me/cyberbayes', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '人工智能, 智能硬件', // 网站关键词 英文逗号隔开
